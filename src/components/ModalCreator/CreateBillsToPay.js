...
const CreateBillsToPaySchemma = yup.object().shape({
  nameProvider: yup.string().required('Fornecedor não informado'),
...
export default function CreateBillsToPay() {
    ...
    <>
      ...
      <div className="Container">
        ...
        >
          ...
          <h2>Cadastro de Contas à Pagar</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className=" text-center mb-3 font-bold text-red-500">
              <p className="mb-1 ">{errors.nameProvider?.message}</p>
